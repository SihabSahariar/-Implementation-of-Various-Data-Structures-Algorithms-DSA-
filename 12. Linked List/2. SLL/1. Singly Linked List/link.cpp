// Linked list wihout default constructor
#include <bits/stdc++.h>
using namespace std;
...
int main()
{
    // create 3 pointer with initial value NULL
    Node *head = NULL;
    Node *second = NULL;
    Node *third = NULL;
    ...
    */
    ...
    /* 
        ...
        And next pointer of the first block points to second. So they both are linked.
    ...
    */
    ...
    third->next = NULL; // link third node to NULL (end of list)

    /* 
        data has been assigned to the data part of the third block (block pointed by third). 
        And next pointer of the third block is made NULL to indicate end of the linked list.
